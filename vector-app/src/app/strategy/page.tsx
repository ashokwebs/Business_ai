    ...
    <div className="px-6 md:px-12 pb-8 max-w-[1600px] mx-auto h-[calc(100vh-4rem)] flex flex-col pt-8">
      <div className="mb-6 flex justify-between items-end shrink-0">
        ...
        <div className="flex gap-3">
          <button className="bg-surface border border-outline-variant text-on-surface px-4 py-2 rounded-md text-sm font-semibold hover:bg-surface-container transition-colors flex items-center gap-2">
      ...
      <div className="flex-1 bg-surface border border-outline-variant rounded-xl flex overflow-hidden shadow-sm">
        
        {/* Document Sidebar */}
        <div className="w-80 border-r border-outline-variant bg-surface-container-low p-4 flex flex-col overflow-y-auto">
          <div className="mb-4">
